...
Forked from [https://github.com/Jberlinsky/rmeetup](https://github.com/Jberlinsky/rmeetup) to add some support for the v2 API for groups.  Pretty hacky changes made, and this gem will not be actively supported.
